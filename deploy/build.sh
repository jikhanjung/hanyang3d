...
(
    cd dist
    sha256sum "hanyang3d-image-$version.tar.gz" "hanyang3d-multiplayer-image-$version.tar.gz" "hanyang3d-data-$version.tar.gz" "hanyang3d-host-$version.tar.gz" > "SHA256SUMS-$version"
)
