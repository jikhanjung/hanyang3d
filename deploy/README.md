...
이미지: **`honestjung/hanyang3d:v0.1.23`**, 플랫폼: `linux/amd64`.
...
- Docker Hub: `honestjung/hanyang3d:v0.1.23`
...
```text
dist/hanyang3d-image-v0.1.23.tar.gz
dist/hanyang3d-data-v0.1.23.tar.gz
dist/hanyang3d-host-v0.1.23.tar.gz
dist/SHA256SUMS-v0.1.23
```
...
scp dist/hanyang3d-*-v0.1.23.tar.gz dist/SHA256SUMS-v0.1.23 dolfinid:~/hanyang3d-release/
```
...
sha256sum -c SHA256SUMS-v0.1.23
docker load -i hanyang3d-image-v0.1.23.tar.gz
sudo install -d -o "$(id -un)" -g "$(id -gn)" /srv/hanyang3d
tar -xzf hanyang3d-host-v0.1.23.tar.gz -C /srv/hanyang3d
mkdir -p /srv/hanyang3d/data
mkdir /srv/hanyang3d/data/v0.1.23
tar -xzf hanyang3d-data-v0.1.23.tar.gz -C /srv/hanyang3d/data/v0.1.23
cd /srv/hanyang3d
