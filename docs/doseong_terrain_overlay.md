...
2026-09-09 사용자 요청에 따라 도성 전체의 3D 지형 위에 원도를 입혀 회전·기울임으로 보는 화면을 다음 목표로 정했다. 현재 구현은 평면 지도와 TPS 오버레이다. 실제 고도 데이터와 3D 렌더러는 아직 추가하지 않았으며, 건물 복원은 별도 후속 작업이다. [실행 계획](plan.md)을 따른다.
