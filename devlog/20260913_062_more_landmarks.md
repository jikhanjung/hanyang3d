...
- 종루 `(1417, 1442)`: 부분도에서 운종가와 남북 대로가 만나는 네거리 곁의 鍾樓 글씨를 확인하고, 전체 원도에서 같은 교차점을 읽어 두 값을 평균했다.
- 의금부 `(1385, 1428)`: 부분도의 노란 칸에 든 義禁府 글씨 중심을 읽어 환산했다. 네거리에서 서쪽으로 약 67 m, 북쪽으로 25 m다.
