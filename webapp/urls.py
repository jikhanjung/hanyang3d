...
urlpatterns = [
    ...
    path('events/agwanpacheon/', views.seoul1907, {'flashback': True}, name='agwanpacheon'),
    path('api/events/agwanpacheon/', views.historical_event),
    path('api/player/action-bar/', views.action_bar),
    path('1907/', views.seoul1907, name='seoul1907'),
    path('credits/', views.credits, name='credits'),
    path('guide/', views.guide, name='guide'),
    path('healthz', views.healthz, name='healthz'),
    path('api/player/', views.player_state, name='player-state'),
    path('api/herbs', views.herb_action, name='herbs'),
    path('api/fishing', views.fishing_action, name='fishing'),
