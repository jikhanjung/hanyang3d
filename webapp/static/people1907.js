...
export function createPerson1907({guard=false,merchant=false,storyteller=false,priest=false}={}){
 ...
 g.userData.era=1907;g.userData.costume=priest?'cassock-concept':guard?'imperial-guard-concept':merchant?'merchant-hanbok':'durumagi-gat';return person;
}
...
export function createStationaryPeople1907(buildings,data,groundAt){
 ...
 function place(record,role,side,index){
  ...
  if(record.indoors&&owner.userData.interior){
