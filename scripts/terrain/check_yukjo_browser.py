...
with sync_playwright() as p:
 ...
 assert not page.locator('#walk-together').is_visible() and page.locator('#map-options-toggle').is_visible()
 ...
 page.locator('#map-options-toggle').click();page.locator('#walk-together').click();assert page.evaluate('terrain3d.firstPerson.active')
